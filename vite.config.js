  ...
  build: {
    rollupOptions: {
      input: {
        ...
        gamebox: resolve(__dirname, 'gamebox/index.html'),
        gameboxPrivacy: resolve(__dirname, 'gamebox/gizlilik-politikasi/index.html'),
        gameboxTerms: resolve(__dirname, 'gamebox/kullanim-sartlari/index.html'),
      },
    },
  },
});
